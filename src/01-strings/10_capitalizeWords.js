...
export function capitalizeWords(str) {
  if (typeof str !== "string")
    throw new TypeError("capitalizeWords: input must be a string");
...
export function capitalizeWordsRegex(str) {
  if (typeof str !== "string")
    throw new TypeError("capitalizeWordsRegex: input must be a string");
...
assertEqual(
  capitalizeWordsRegex("  hello   world  "),
  "Hello World",
  "regex trim + multi",
);
